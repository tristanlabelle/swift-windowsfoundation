...
public enum WindowsFoundationCollections_IPropertySetProjection: WinRTTwoWayProjection {
    ...
    private final class Implementation: WinRTImport<WindowsFoundationCollections_IPropertySetProjection>, WindowsFoundationCollections_IPropertySetProtocol {
