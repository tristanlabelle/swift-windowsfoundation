...
internal enum WindowsFoundation_IDeferralProjection: WinRTTwoWayProjection {
    ...
    private final class Implementation: WinRTImport<WindowsFoundation_IDeferralProjection>, WindowsFoundation_IDeferralProtocol {
